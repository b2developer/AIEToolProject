...
namespace AIEToolProject.Source.Exporter
{
    ...
    */
    public class CS_Exporter : BaseExporter
    {
        ...
        */
        ...
        {
            stream = File.Create(exportingPath + "\\export.cs");

            //start of the program, using statements and namespace definition
            Write("using System;\r\n");
        ...
        */
        ...
        {
            //input class
            Write("\tpublic class DerivedInput : BT.Input\r\n");
            Write("\t{\r\n");
            Write("\r\n");
            Write("\t}\r\n");
            ...
            //tree builder class
            Write("\tpublic class TreeBuilder\r\n");
            Write("\t{\r\n");
            Write("\r\n");
            Write("\r\n");
        }
        ...
        public override void CreateFunctionReferences()
        {
            ...
            for (int i = 0; i < nodeSize; i++)
            {
                ...
                for (int j = 0; j < additives.Count; j++)
                {
                    ...
                    Write("\t\tpublic BT.BehaviourReturn ");
                    ...
                    switch (node.type)
                    {
                        ...
                        case NodeType.DECORATOR: Write("BT.Decorator node, List<BT.Behaviour> children)"); break;
                    }
        ...
        */
        ...
        {
            Write("\t\tpublic BT.BehaviourTree CreateTree()\r\n");
            Write("\t\t{\r\n");
            Write("\r\n");
            Write("\t\t\tInput input = new DerivedInput();\r\n");
            Write("\r\n");
        ...
        public override void DefineStructure()
        {
            ...
            for (int i = 0; i < nodeSize; i++)
            {
                ...
                for (int j = 0; j < childSize; j++)
                {
                    ...
                    Write("\t\t\t" + safeName + ".children.Add(" + safeChildName + ");\r\n");
                }
